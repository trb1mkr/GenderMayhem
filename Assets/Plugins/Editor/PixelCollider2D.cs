...
public sealed class PixelCollider2D : MonoBehaviour
{
    ...
    public PolygonCollider2D PGC2D;
    ...
    public void Regenerate()
    {
        ...
        Pixel_Paths = Get_Unit_Paths(CropTexture(SR.sprite), alphaCutoff);
    ...
    private Texture2D CropTexture(Sprite sprite)
    {
