...
public class Bullet : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        BulletRigidBody.AddForce(new Vector2(gameObject.transform.right.x, gameObject.transform.right.y) * bulletSpeed, ForceMode2D.Force);
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        try { collision.gameObject.GetComponent<Glass>().BreakGlass(); } catch { }
        Destroy(gameObject);
    }
}
